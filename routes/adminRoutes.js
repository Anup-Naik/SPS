...
router.post("/faculty", isLoggedIn, isLoggedInAdmin, catchAsync(createFaculty));
...
router.get(
  ...
  isLoggedIn,
  isLoggedInAdmin,
  catchAsync(toggleStudentAccess)
);
...
router.post("/student", isLoggedIn, isLoggedInAdmin, catchAsync(createStudent));
